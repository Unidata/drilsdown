...
A script is generated to teleport a simple IDV bundle comprising of 3D data from two reanalysis to a lat-lon bounding box 17 - 36 , -15 - 90 (North - West ,South - East).
...
`Cases<https://weather.rsmas.miami.edu/repository/entry/show?entryid=a4154517-ac1c-4eb4-b842-572cb55ce1f2>`_ are then published to RAMADDA server using following command:
